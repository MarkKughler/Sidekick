...
#define LOG_INFO(info, x) std::cout << _ec(32) << "[Info] " << #info << " " << x << _ec(0) << std::endl;
...
#define LOG_ERROR(x, info) std::cout << _ec(41)_ec(30) << "[Error] " << x << "    \n" << info << _ec(0) << std::endl;
#define LOG_WARN(x, info) std::cout << _ec(43)_ec(30) << "[Warning] " << x << "    \n" << info << _ec(0) << std::endl;

#define LOG_BLOCK_START std::cout << _ec(36);
#define LOG_BLOCK_END std::cout << _ec(0) << std::endl;
#define LOG_WARN_START(x) std::cout << _ec(43)_ec(30) << "[Warning] " << x << "  \n";
#define LOG_ERROR_START(x) std::cout << _ec(41)_ec(30) << "[Error] " << x << "\n";
